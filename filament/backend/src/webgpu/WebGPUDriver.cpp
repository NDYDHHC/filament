...
void WebGPUDriver::bindRenderPrimitive(Handle<HwRenderPrimitive> renderPrimitiveHandle) {
    auto* renderPrimitive = handleCast<WGPURenderPrimitive>(renderPrimitiveHandle);
    auto vertexBufferInfo = handleCast<WGPUVertexBufferInfo>(renderPrimitive->vertexBuffer->vbih);

...
private:
    ...
    using PendingSynchronousProgram =
            std::tuple<program_token_t, Program, OpenGLBlobCache::Blob::Ptr, size_t>;
    ...
    void maybeCompileSynchronousProgram(program_token_t const& token, Program&& program,
            OpenGLBlobCache::Blob::Ptr blob, size_t blobSize) noexcept;
    void compileSynchronousProgram(program_token_t const& token, Program&& program,
            OpenGLBlobCache::Blob::Ptr blob, size_t blobSize) noexcept;
    void compilePendingSynchronousPrograms() noexcept;
    bool cancelSynchronousCompile(program_token_t const& token) noexcept;
